...
def predict(image, image_size, model_file, num_classes):
    num_channels=3
    images = []
    ...
    # Now, let's get hold of the op that can be processed to get the output.
...
def train(train_path, num_iteration, model_name):
    batch_size = 32
